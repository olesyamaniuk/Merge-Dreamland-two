document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".s-navigation-list");
  const headerRef = document.querySelector(".s-header");
  const navigationRef = document.querySelector(".s-navigation");
